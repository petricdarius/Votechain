...
export async function initHardhat3NonInteractive(options) {
    const [template, projectTypeAnalyticsPromise] = await getTemplate("hardhat-3", options.template, true);
 ...
 */
export async function getTemplate(hardhatVersion, template, includeAvailableTemplatesInErrors = false) {
 ...
 *  printed.
 */
export async function printTemplatesList(hardhatVersion, print = console.log) {
    const templates = await getTemplates(hardhatVersion);
